...
public class ValidatedPojoTest extends AbstractPodamSteps {
	...
	public void podamShouldFulfillTimeConstraintsOfTheJakartaValidation30Framework() throws Exception {
		...
		podamValidationSteps.theObjectShouldNotBeNull(pojo.getHijrahDate());
		podamValidationSteps.theObjectShouldNotBeNull(pojo.getJapaneseDate());
		podamValidationSteps.theObjectShouldNotBeNull(pojo.getMinguoDate());
		...
		podamValidationSteps.theObjectShouldNotBeNull(pojo.getMonthDay());
