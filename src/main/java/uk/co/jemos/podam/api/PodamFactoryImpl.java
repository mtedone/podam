...
public class PodamFactoryImpl implements PodamFactory {
     ...
     *
     * @param externalFactory External factory to delegate production this factory cannot
     *                        handle
     */
     ...
     * @param factoryClass     The factory class, which will be used for POJO instantiation
     ...
     * @param typeArgsMap      a map relating the generic class arguments ("&lt;T, V&gt;" for
     *                         example) with their actual types
     * @param genericTypeArgs  The generic type arguments for the current generic class
     *                         instance
     ...
     * @throws InvocationTargetException If an exception occurred while invoking the constructor or
     *                                   factory method
    ...
    private <T> T populatePojoInternal(T pojo, List<Annotation> annotations,
        ...
        while (iter.hasNext()) {
            ...
            if (pojoAttributeAnnotations.size() > 1) {
                pojoAttributeAnnotations = PodamUtils.filterNonPodamAnnotations(pojoAttributeAnnotations);
            }
     ...
     *                             manufactured
     * @param genericAttributeType The generic type of the attribute for which a value is being
     *                             manufactured
     ...
     * @param <T>              The type of the instance to return
     * @param manufacturingCtx the manufacturing context
     * @param msg              Message to log, must contain two parameters
     * @param pojoClass        The class of which an instance is required
     * @param genericTypeArgs  The generic type arguments for the current generic class
     *                         instance
     ...
     * @param manufacturingCtx       the manufacturing context
     * @param elementGenericTypeArgs parameter to return generic arguments of collection element
     * @param typeArgsMap            a map relating the generic class arguments ("&lt;T, V&gt;" for
     *                               example) with their actual types
     * @param genericTypeArgs        The generic type arguments for the current generic class
     *                               instance
     * @return class type of collection element
     */
     ...
     *
     * @param map              The map being initialized
     * @param manufacturingCtx the manufacturing context
     * @param typeArgsMap      a map relating the generic class arguments ("&lt;T, V&gt;" for
     *                         example) with their actual types
     * @param genericTypeArgs  The generic type arguments for the current generic class
     *                         instance
     * @return Inherited map key and element types
     */
     ...
     * </p>
     *
     * @param mapArguments     The arguments POJO
     ...
     *
     * @param keyOrElementsArguments The arguments POJO
     * @param manufacturingCtx       manufacturing context
     ...
     *                                   desired type</li>
     *                                   </ul>
     * @throws ClassNotFoundException    If manufactured class could not be loaded
     */
     ...
     *
     * @param pojo              POJO containing attribute
     * @param manufacturingCtx  the manufacturing context
     * @param attributeMetadata The attribute's metadata
     * @param typeArgsMap       a map relating the generic class arguments ("&lt;T, V&gt;" for
     *                          example) with their actual types
     ...
     * required to invoke it
     *
     * @param method           The method for which parameter values are required
     * @param pojoClass        The POJO class containing the constructor
     * @param manufacturingCtx the manufacturing context
     * @param typeArgsMap      a map relating the generic class arguments ("&lt;T, V&gt;" for
     *                         example) with their actual types
     ...
     * @throws IllegalArgumentException  If an illegal argument was passed to the method
     * @throws InstantiationException    If an exception occurred during instantiation
     * @throws IllegalAccessException    If security was violated while creating the object
     * @throws InvocationTargetException If an exception occurred while invoking the constructor or
     *                                   factory method
