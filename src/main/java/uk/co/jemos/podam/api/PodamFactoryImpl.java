        ...
        if (null != attributeStrategyAnnotation) {
            ...
            if (attributeType.equals(pojoClass)) {
                ...
                if (Collection.class.isAssignableFrom(attributeType)) {
                    ...
                    /*
                     * JSM TODO: pass the pojoObject here
                     */
        ...
        try {
            ...
            if (classInfo.getClassSetters().isEmpty()) {
                ...
                for (String attributeName : work) {
                    ...
                    if (PodamConstants.EXCLUDE_UNANNOTATED_FIELDS && pojoAttributeAnnotations.isEmpty()) {
                        continue;
                    }
                    hasWorkToDo = true;
                    break;
            ...
            for (String attributeName : work) {
                ...
                /*
                 * I like the idea of "final fields will have been initialized
                 * by the constructor so don't re-initialize them. But I don't
                 * see how to make it work.
                 *
                 * From the definition of isFinal(): "If this object represents
                 * an array class, a primitive type or void, then its final
                 * modifier is always true" However, isPrimitive() does not
                 * return true for a String, and it is neither Array nor
                 * Synthetic; but it does return true for isFinal(). Ouch.
                 *
                 * The field methods don't seem to help either.
                 */
                //        int modifiers = attributeType.getModifiers();
                ...
                //        }
                /*
                 * I suppose we could look for @Podam annotations on each of the
                 * fields to decide whether to re-initialize one based on the
                 * idea that the annotation asks for it.
                 */
                if (PodamConstants.EXCLUDE_UNANNOTATED_FIELDS && pojoAttributeAnnotations.isEmpty()) {
                    continue;
                }
